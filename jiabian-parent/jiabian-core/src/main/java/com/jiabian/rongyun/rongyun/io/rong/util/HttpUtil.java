package com.jiabian.rongyun.rongyun.io.rong.util;
...
public class HttpUtil {
	...
	// 添加签名header
	public static HttpURLConnection CreatePostHttpConnection(String appKey, String appSecret, String uri) throws MalformedURLException,
