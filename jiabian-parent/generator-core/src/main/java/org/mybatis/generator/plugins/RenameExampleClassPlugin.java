...
public class RenameExampleClassPlugin extends PluginAdapter {
    ...
    public static void main(String[] args) {
    	RenameExampleClassPlugin plugin=new RenameExampleClassPlugin();
    	plugin.pattern= Pattern.compile("aaaa");
    	
    	 String oldType = "com.aa.userExample";
         Matcher matcher = plugin.pattern.matcher(oldType);

         oldType=matcher.replaceAll("queryHeloer");
